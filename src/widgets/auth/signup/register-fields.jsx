...
export const RegisterFields = ({ isSubmitting, isValid, dirty }) => {
        ...
        <Flex flexDir="column" gap={4} w="100%" maxW="280px">
          ...
          <Box ref={(ref) => setRef("signupRef", ref, t("common:USER.AUTH.SIGNUP"))}>
            <PButton
              ...
              w="100%"
              maxW="280px"
              isDisabled={isSubmitting || !(terms_status && phone && social_title && gender && country && isValidPhoneNumber(phone) && isValid && dirty)}
