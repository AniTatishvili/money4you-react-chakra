...
import { SellerDashboardCustomerDetails } from "./seller-dashboard-customer-details";
...
export const SellerDashboardCustomer = ({ username }: ChiefSellerDashboardSellerCustomerProps) => {
  ...
  return (
    <Flex flexDirection={"column"} w={"95%"} ml={"auto"} my={"10"}>
      ...
      {showCustomerDetails && customerData ? <SellerDashboardCustomerDetails cdata={customerData} /> : null}
    </Flex>
  );
};
